...
public class RestOpenSearchClientTest {
    ...
    private RestOpenSearchClient client;

    private RestOpenSearchClient proxyClient;
    ...
    public void setup() throws UnsupportedOperationException, IOException {
        ...
        client = new RestOpenSearchClient(mockRestClient);
        proxyClient = new RestOpenSearchClient(mockRestClient, mockProxyRestClient, true);
    ...
    public void testVersionWithInvalidFormat() throws IOException {
        mockVersion("6");
        final double version = client.getVersion();
        assertEquals(RestOpenSearchClient.DEFAULT_VERSION, version, 1e-9);
    }
    ...
    public void testSearchStoredFields() throws IOException {
        ...
        final RequestMatcher matcher2 =
                new RequestMatcher("/status_s/_search", "{\"stored_fields\":[\"obj1\"]}");
    ...
    public void testSearchStoredFieldsWithProxyClient() throws IOException {
        ...
        final RequestMatcher matcher2 =
                new RequestMatcher(
                        "POST", "/status_s/_search", "{\"stored_fields\":[\"obj1\"]}", "runAsTest");
    ...
    public void testSearchResponse() throws IOException {
        ...
        final OpenSearchResponse response =
                client.search("status_s", "active", new OpenSearchRequest());
    ...
    public void testSearchResponseWithProxyClient() throws IOException {
        ...
        final OpenSearchResponse response =
                proxyClient.search("status_s", "active", new OpenSearchRequest());
        assertEquals(10, response.getResults().getTotal().intValue());
        assertEquals("index_name", response.getHits().get(0).getIndex());
        assertEquals(0.8f, response.getResults().getMaxScore(), 1e-9);
    }
    ...
    public void testRemoveMapping() {
        ...
        RestOpenSearchClient.removeMapping(null, "key", data, null);
        ...
        RestOpenSearchClient.removeMapping("parent", "key", data, null);
    ...
    class RunAsHeaderMatcher implements ArgumentMatcher<BasicHeader> {
        ...
        private static final String RUN_AS_HEADER_FIELD = "opendistro_security_impersonate_as";
