...
/** Visitor to generate Opensearch aggregate buckets or native queries */
public class OpenSearchBucketVisitor implements FeatureAttributeVisitor {
    ...
    public OpenSearchBucketVisitor(String aggregationDefinition, String queryDefinition) {
    ...
    public void visit(Feature feature) {
        throw new RuntimeException(
                "The OpenSearchBucketVisitor is only for Opensearch data sources "
