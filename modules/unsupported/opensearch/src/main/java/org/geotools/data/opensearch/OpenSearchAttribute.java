...
/**
 * Class describing and OpenSearch attribute including name, type and optional information on
 * geometry and date types.
 */
public class OpenSearchAttribute implements Serializable, Comparable<OpenSearchAttribute> {

    public enum OpenSearchGeometryType {
        GEO_POINT,
        GEO_SHAPE
    }
    ...
    private OpenSearchGeometryType geometryType;
    ...
    public OpenSearchAttribute(String name) {
        super();
        this.name = name;
        this.use = true;
    ...
    public OpenSearchAttribute(OpenSearchAttribute other) {
    ...
    public OpenSearchGeometryType getGeometryType() {
        return geometryType;
    }

    public void setGeometryType(OpenSearchGeometryType geometryType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || getClass() != obj.getClass()) {
            ...
            OpenSearchAttribute other = (OpenSearchAttribute) obj;
     ...
     *
     * @param o is a non-null OpenSearchAttribute
     * @return negative for before, zero for same, positive after
     */
    @Override
    public int compareTo(@SuppressWarnings("NullableProblems") OpenSearchAttribute o) {
        if (this.order == null) {
