 ...
 * and {@link BegunBy}.
 */
class OpenSearchCapabilities extends Capabilities {
    ...
    public OpenSearchCapabilities() {
        super(new OpenSearchFilterCapabilities());
    ...
    public boolean fullySupports(Filter filter) {
        if (fullySupportedVisitor == null) {
            fullySupportedVisitor = new OpenSearchIsFullySupportedFilterVisitor();
        }
    ...
    private static class OpenSearchFilterCapabilities extends FilterCapabilitiesImpl {
    ...
    private class OpenSearchIsFullySupportedFilterVisitor extends IsFullySupportedFilterVisitor {

        OpenSearchIsFullySupportedFilterVisitor() {
            super(getContents());
        }
