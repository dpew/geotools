...
public class OpenSearchResponse {
    ...
    @JsonProperty("hits")
    private OpenSearchResults results;
    ...
    public OpenSearchResults getResults() {
        return results;
    }

    public Map<String, OpenSearchAggregation> getAggregations() {
        return aggregations;
    }
    ...
    public String toString() {
        return "OpenSearchResponse[total="
                + getTotalNumHits()
                + ", hits="
                + getNumHits()
                + ", aggregations="
