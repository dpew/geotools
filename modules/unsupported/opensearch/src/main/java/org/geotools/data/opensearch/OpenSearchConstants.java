...
final class OpenSearchConstants {
    ...
    /**
     * Key used in the feature type user data to store the OpenSearch geometry type ({@link
     * OpenSearchAttribute.OpenSearchGeometryType}).
     */
