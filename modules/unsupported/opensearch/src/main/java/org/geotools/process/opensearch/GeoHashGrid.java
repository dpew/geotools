...
import static org.geotools.process.opensearch.GridCoverageUtil.pad;
...
abstract class GeoHashGrid {
    ...
    private List<Map<String, Object>> readFeatures(
        ...
        OpenSearchBucketVisitor visitor =
                new OpenSearchBucketVisitor(aggregationDefinition, queryDefinition);
